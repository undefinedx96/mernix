...
import { changeCurrentPasswordSchema, loginUserSchema, registerFileSchema, registerUserSchema, updateAccountDetailsSchema } from '../validators/auth.validator.ts';
...
userRouter.route('/update-account-details').patch(verifyJWT, validate(updateAccountDetailsSchema), updateAccountDetails);
